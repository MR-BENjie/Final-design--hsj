...
class Env(object):
    ...
    def reset(self):
        ...
        self.action_recorder = []
        return self._extract_relation_score_state(state),self._extract_dangerous_state(state), player_id,self._extract_red_10_state(state)
    ...
    def step(self, action, color = None):
        ...
        next_state, player_id = self.game.step(action, color)

        return self._extract_relation_score_state(next_state),self._extract_dangerous_state(next_state), self._extract_red_10_state(next_state), self.game.is_over()
