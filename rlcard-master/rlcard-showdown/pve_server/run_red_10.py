...
def predict():
    if request.method == 'POST':
        try:
            ...
            if len(player_hand_cards) < 1 or len(player_hand_cards) > 13:
            ...
            if num_cards_left[0] < 0 or num_cards_left[1] < 0 or num_cards_left[2] < 0 or num_cards_left[3] < 0 or num_cards_left[0] > 13 or \
                    num_cards_left[1] > 13 or num_cards_left[2] > 13 or num_cards_left[3] > 13:
